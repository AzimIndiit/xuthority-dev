        ...
        <div className="md:w-1/3 flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-2">
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="bg-white rounded p-1.5 inline-flex">
              ...
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="bg-white rounded p-1.5 inline-flex">
                <svg className="w-6 h-6 text-[#111]" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="#" aria-label="LinkedIn" className="bg-white rounded p-1.5 inline-flex">
                <svg className="w-6 h-6 text-[#111]" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Skype */}
              <a href="#" aria-label="Skype" className="bg-white rounded p-1.5 inline-flex">
                <svg className="w-6 h-6 text-[#111]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.002 2.002c-2.137 0-4.15.833-5.657 2.34-1.507 1.507-2.34 3.52-2.34 5.657 0 1.01.164 1.99.484 2.91l-.01.01c-.01.01-.01.02-.01.03 0 .01 0 .02.01.03l.01.01c.92.32 1.9.484 2.91.484 2.137 0 4.15-.833 5.657-2.34 1.507-1.507 2.34-3.52 2.34-5.657 0-1.01-.164-1.99-.484-2.91l.01-.01c.01-.01.01-.02.01-.03 0-.01 0-.02-.01-.03l-.01-.01c-.92-.32-1.9-.484-2.91-.484zm0 1.5c.82 0 1.62.13 2.37.37.24.07.47.16.7.25.23.09.45.19.67.3.22.11.43.23.64.36.21.13.41.27.6.42.19.15.37.31.54.48.17.17.33.35.48.54.15.19.29.39.42.6.13.21.25.42.36.64.11.22.21.44.3.67.09.23.18.46.25.7.24.75.37 1.55.37 2.37 0 4.14-3.36 7.5-7.5 7.5-.82 0-1.62-.13-2.37-.37-.24-.07-.47-.16-.7-.25-.23-.09-.45-.19-.67-.3-.22-.11-.43-.23-.64-.36-.21-.13-.41-.27-.6-.42-.19-.15-.37-.31-.54-.48-.17-.17-.33-.35-.48-.54-.15-.19-.29-.39-.42-.6-.13-.21-.25-.42-.36-.64-.11-.22-.21-.44-.3-.67-.09-.23-.18-.46-.25-.7-.24-.75-.37-1.55-.37-2.37 0-4.14 3.36-7.5 7.5-7.5z"/>
                </svg>
              </a>
            </div>
          </div>
