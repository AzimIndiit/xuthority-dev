            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
              <div>
                ...
                <p className="text-lg leading-relaxed mb-6">
                  Welcome to XUTHORITY. These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with XUTHORITY website (the "Service") operated by XUTHORITY ("us", "we", or "our").
                </p>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Content must be truthful and based on your actual experience</li>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  The Service and its original content, features and functionality are and will remain the exclusive property of XUTHORITY and its licensors. The Service is protected by copyright, trademark, and other laws. Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p><strong>Email:</strong> legal@xuthority.com</p>
                  <p><strong>Address:</strong> XUTHORITY Legal Department</p>
