      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600">
              {userInfo ? `Hi ${userInfo.firstName}, enter your new password for ${userInfo.email}` : 'Enter your new password below'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="pt-4">
              <Button
                type="submit"
                disabled={resetPasswordMutation.isPending}
                className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-full h-12 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
