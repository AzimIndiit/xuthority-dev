...
export const PrivacyPolicyPage: React.FC = () => {
  const { data: pageData, isLoading, error } = usePageBySlug('privacy-policy');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Failed to load Privacy Policy. Please try again later.</p>
        </div>
      </div>
    );
  }
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
              <div>
                ...
                <p className="text-lg leading-relaxed mb-6">
                  At XUTHORITY, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
                </p>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Enabling you to post reviews and interact with our platform</li>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  Your information may be transferred to and processed in countries other than your country of residence. These countries may have data protection laws that are different from those of your country. We ensure appropriate safeguards are in place to protect your information during such transfers.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p><strong>Email:</strong> privacy@xuthority.com</p>
                  <p><strong>Data Protection Officer:</strong> dpo@xuthority.com</p>
                  <p><strong>Address:</strong> XUTHORITY Privacy Team</p>
